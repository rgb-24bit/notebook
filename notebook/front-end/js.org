...
* 相关术语
  + Falsy 值是在 Boolean 上下文中认定为 false 的值。参考：[[https://developer.mozilla.org/zh-CN/docs/Glossary/Falsy][Falsy - 术语表 | MDN]]
  + Truthy 值是在 Boolean 上下文中，转换后的值为真的值。参考：[[https://developer.mozilla.org/zh-CN/docs/Glossary/Truthy][Truthy - 术语表 | MDN]]
